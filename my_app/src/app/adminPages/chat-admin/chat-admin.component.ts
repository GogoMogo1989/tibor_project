...
export class ChatAdminComponent {
  ...
  //Ellenőrizzük, hogy az üzenetet a felhasználó küldte-e, vagy a felhasználó kapta-e, és ezálltal változik az email cím, és így a visszatérő üzenet listájához adódik hozzá
